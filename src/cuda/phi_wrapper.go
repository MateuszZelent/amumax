...
)
{
	...
	ld.param.u32 	%r6, [setPhi_param_3];
	ld.param.u32 	%r7, [setPhi_param_4];
	ld.param.u32 	%r8, [setPhi_param_5];
	mov.u32 	%r9, %ctaid.x;
	mov.u32 	%r10, %ntid.x;
	mov.u32 	%r11, %tid.x;
...
BB0_3:
	...
	mov.b32 	 %f33, %r22;
	add.f32 	%f34, %f1, %f2;
	setp.gtu.f32	%p14, %f34, 0f7F800000;
	selp.f32	%f35, %f34, %f33, %p14;
