...
func init() {
	...
	DeclFunc("SinWaveguide2", sinWaveguide2, "Full-featured sinusoidal waveguide along x. Arguments: length, width, height, period, centerAmp, phase, z0 (all in meter/radians). centerAmp is the centerline amplitude; outer envelope = centerAmp + height/2. Thickness is measured vertically along z.")
	DeclFunc("SinWaveguideNormal", sinWaveguideNormal, "Sinusoidal waveguide with thickness measured orthogonally to the centerline in the x-z plane. Arguments: length, width, height, period, centerAmp, phase, z0 (all in meter/radians). Prefer this over SinWaveguide2 when curvature-induced staircase artifacts matter.")
	DeclFunc("ArchWaveguide", archWaveguide, "Half-sine arch waveguide along x. Arguments: length, width, height, archHeight, z0 (all in meter). Centerline follows a single half-sine from z0 at both ends to z0+archHeight at the center. Thickness is measured vertically along z.")
	DeclFunc("ArchWaveguideNormal", archWaveguideNormal, "Half-sine arch waveguide with thickness measured orthogonally to the centerline in the x-z plane. Arguments: length, width, height, archHeight, z0 (all in meter). Prefer this over ArchWaveguide when curvature-induced staircase artifacts matter.")
