export const quantities: { [category: string]: string[] } = {
	...
	Geometry: ['geom', 'geom_phi', 'geom_fx', 'geom_fy', 'geom_fz', 'geom_link_x', 'geom_link_y', 'geom_link_z', 'geom_nx', 'geom_ny', 'geom_nz', 'geom_thickness_z', 'geom_face_x', 'geom_face_y', 'geom_face_z', 'demag_boundary_shell'],
